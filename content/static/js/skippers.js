...
$(document).ready(function()
{
    ...
    $('#button_delete_skipper').click(function()
    {
        ...
        $('#button_delete_skipper').prop('disabled', true);
        $('#cancel_delete_skipper').prop('disabled', true);
        $.post(
            {
                url: window.location.href,
            ...
            function(data, status){
                ...
                $('#button_delete_skipper').prop('disabled', false);
                $('#cancel_delete_skipper').prop('disabled', false);
                if (status === 'success')
                {
                    $('.menu').html($(data).find('.menu').html());
                    $('#skipper_table').html($(data).find('#skipper_table').html());
